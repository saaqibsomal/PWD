...
{
    public partial class ReportViewerQSP : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                localReport.ReportPath = ".\\Reports\\QuotaSamplingProgressSurveyorWise.rdlc";
                ...
                DataSet ds = GetDataSet(strFrom, strTo);
        ...
        private System.Data.DataSet GetDataSet(string dtFrom, string dtTo)
        {
            ...
            sqlConn.Open();
            string sql = "exec GetSurveyorProgressForSampling";
