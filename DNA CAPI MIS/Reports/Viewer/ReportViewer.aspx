<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportViewer.aspx.cs" Inherits="DNA_CAPI_MIS.Reports.Viewer.ReportViewer" %>
...
<body>
    ...
    <div>
        <div>Date From: </div><asp:Calendar ID="Calendar1" runat="server"></asp:Calendar>
        <div>Date To: </div><asp:Calendar ID="Calendar2" runat="server"></asp:Calendar>
    </div>
    <div>
